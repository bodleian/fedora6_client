...
"""
  ...
  config.before(:each) do
    ...
    stub_request(:get, "https://test.com/base/uuid_12345678-1234-1234-1234-12345678abcd/fcr:versions")
      .to_return(status: 200, body: versions_list)
    stub_request(:post, "https://test.com/base/uuid_12345678-1234-1234-1234-12345678abcd/fcr:versions")
      .to_return(status: 201, headers: { Location: "https://test.com/base/uuid_12345678-1234-1234-1234-12345678abcd/fcr:versions/20230428141820" }, body: nil)
    ...
    stub_request(:head, "https://test.com/base/uuid_12345678-1234-1234-1234-12345678abcd/fcr:versions/20230428141819")
      .to_return(status: 200, headers: {"Memento-Datetime" => 'Fri, 28 Apr 2023 13:59:09 GMT'}, body: "[]")
    stub_request(:head, "https://test.com/base/uuid_12345678-1234-1234-1234-12345678abcd/fcr:versions/20230428141820")
      .to_return(status: 200, headers: {"Memento-Datetime" => 'Sat, 30 Apr 2023 13:59:09 GMT'}, body: "[]")
